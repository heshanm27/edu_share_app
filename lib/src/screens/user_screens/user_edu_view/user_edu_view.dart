...
import 'package:edu_share_app/src/forms/edu_apply_form/edu_apply_form.dart';
...
class UserEduView extends StatelessWidget {
  final EduPostModel model;

  UserEduView({Key? key, required this.model}) : super(key: key);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          IconCard(Icons.monetization_on_rounded,'Course Fee',model.courseFee.toString() == 0 ?'Free' :model.courseFee.toString() +' LKR'),
                          IconCard(Icons.calendar_month,'Course Duration',model.courseDuration!),
                          IconCard(Icons.timer,'Closing Date',model.closingDate!),
                        ],
                      ),
                    ),
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Get.to(() => EduApplyForm(updateModel:model,));
                      },
                      child: Text('Apply'),
